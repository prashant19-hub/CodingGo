...
func main() {
	...
	// pointer use in non primitive data type(*)
var studentAddress1 *student
      studentAddress1 = &student1
	  fmt.Println("Student Address no1:", studentAddress1)
	  fmt.Println("Student Address no1 Name:", studentAddress1.Name)
